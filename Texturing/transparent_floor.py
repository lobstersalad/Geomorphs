...
img = Image.open('bw_test_dungeon.png')
...
img.save("transparent_floor_dungeon.png", "PNG")
...
overlay = cv2.imread("transparent_floor_dungeon.png", -1) # Load with transparency
...
cv2.imwrite("textured_floors_transparency.png", result)
